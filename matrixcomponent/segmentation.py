...
def find_dividers(matrix: List[Path]) -> Tuple[Dict[int, Dict[int, set]],
    ...
    if not args.ignore_zero:
        print("WARNING: Links to 0 Bin were included.  To change this use '--ignore_zero'")
    print(uniq_links)
...
def get_arguments():
    ...
    parser.add_argument('-0', '--ignore_zero',
                        default=False,
                        action='store_true',
                        help='Ignores all links to the zero index bin.')
